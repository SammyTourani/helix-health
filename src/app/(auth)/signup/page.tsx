  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-[#0a0a0f] px-4">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -right-40 -top-40 h-80 w-80 rounded-full bg-[#6366f1]/10 blur-[120px]" />
        <div className="absolute -bottom-40 -left-40 h-80 w-80 rounded-full bg-[#6366f1]/8 blur-[120px]" />
      </div>
        ...
        <Card className="border-[#1e1e2e] bg-[#12121a] shadow-2xl shadow-[#6366f1]/5">
          <CardHeader className="space-y-1 pb-4">
            ...
            <CardDescription className="text-center text-[#94a3b8]">
              Start your health journey with Helix
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="fullName" className="text-[#f8fafc]">
                  Full Name
                </Label>
              ...
              {/* Confirm Password */}
              <div className="space-y-2">
                <Label htmlFor="confirmPassword" className="text-[#f8fafc]">
                  Confirm Password
                </Label>
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[#94a3b8]" />
